        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <a href="{{route('startQuiz')}}" class=" tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-1 px-6 items-center">{{ __('Take a New Quiz') }}</a>
                    <p class="tracking-wide font-bold rounded @if(round($quizAverage,2)<70) bg-red-500 @endif  @if(round($quizAverage,2)>=70) bg-green-600 @endif text-white shadow-md py-2 px-6 items-center">{{ __('Average Score:') }} <span class="mx-2"> {{round($quizAverage,2) .'%'}}</span></p>
                </div>
                        ...
                        <div class="flex flex-wrap -m-4 text-center">
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <p class="leading-relaxed">{{ __('Sections') }}</p>
                                </div>
                            </div>
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                            ...
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <p class="leading-relaxed">{{ __('Questions') }}</p>
                                </div>
                            </div>
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <p class="leading-relaxed">{{ __('Quizzes Taken') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        {{ __('Looks like you have just landed! Once you have taken a quiz it will be listed here.') }}
                    </p>
                </div>
                @else
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-green-100">
                                            ...
                                            <td class="px-6 py-1">
                                                <div class="text-sm text-gray-900">{{ $quiz->completed ? 'Terminado' : 'No terminado' }}</div>
                                            </td>
                                            <td class="px-6 py-1">
                                                <div class="text-sm ">
    ...
    <script>
        const chart = new Chartisan({
            ...
            loader: {
                ...
                type: 'bar',
                textColor: '#ffff00',
                text: 'Cargando algunos datos del gráfico...',
            },
            hooks: new ChartisanHooks()
                .colors()
                .beginAtZero()
                .title('Puntuaciones de las pruebas')
                .datasets(['line'])
                .stepSize(25)
                .responsive()
        });
